...
Работа с аргументами у *slash*-команд устроена иначе, нежели у *prefix*-команд. Чтобы `PyCord` распознал аргумент и передал его в дискорд, в качестве аннотации типа аргумента команды нужно указать экземпляр класса [`discord.Option`][38]
