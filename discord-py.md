...
В случае, если вы хотите использовать [`discord.ext.commands.Bot`][7], я бы сразу отдельно подключил еще и этот пакет
```py
...
[**Почитать про *slash*-команды можно здесь.**][35]
...
Если смешать все команды из базового руководства в один код, то должно получиться что-то [**такое**][33].
...
- [**UI-Элементы (Кнопки, выпадающие списки и дилоговые окна)**][37]
...
[37]: https://github.com/denisnumb/discord-py-guide/blob/main/ui_elements.md
